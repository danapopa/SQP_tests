...
test('Winsane staging deposit via Convertiq Swish', async ({ browser }) => {
  ...
  try {
    ...
    await winsane.selectPaymentMethod('#card_payment_swish___convertiq__payment_methods_adaptor_10');
